    ...
    >
      <div className="legal-page__inner">
        ...
        <header className="legal-page__header">
          <span className="legal-page__label">Données personnelles</span>
        ...
        <div className="legal-page__content" style={{ backgroundColor: '#fff', color: '#1f2937' }}>
          ...
          <section className="legal-page__section">
            <h2 className="legal-page__sectionTitle">Responsable du traitement</h2>
          ...
          <section className="legal-page__section">
            <h2 className="legal-page__sectionTitle">Données collectées</h2>
            <p className="legal-page__paragraph">
          ...
          <section className="legal-page__section">
            <h2 className="legal-page__sectionTitle">Finalités du traitement</h2>
            <p className="legal-page__paragraph">
          ...
          <section className="legal-page__section">
            <h2 className="legal-page__sectionTitle">Base légale du traitement</h2>
            <p className="legal-page__paragraph">
          ...
          <section className="legal-page__section">
            ...
            <ul className="legal-page__list">
              <li>Vous pouvez vous désinscrire à tout moment en nous contactant à{' '}
                <a href="mailto:contact@saussetreuni.fr" className="legal-page__link">contact@saussetreuni.fr</a>
          ...
          <section className="legal-page__section">
            <h2 className="legal-page__sectionTitle">Cookies</h2>
            <p className="legal-page__paragraph">
          ...
          <section className="legal-page__section">
            <h2 className="legal-page__sectionTitle">Durée de conservation</h2>
            <p className="legal-page__paragraph">
          ...
          <section className="legal-page__section">
            <h2 className="legal-page__sectionTitle">Destinataires des données</h2>
            <p className="legal-page__paragraph">
          ...
          <section className="legal-page__section">
            <h2 className="legal-page__sectionTitle">Droits des personnes</h2>
            <p className="legal-page__paragraph">
            ...
            <div className="legal-page__cnilBox" role="region" aria-label="Réclamation CNIL">
              <h3 className="legal-page__cnilBoxTitle">Réclamation auprès de la CNIL</h3>
              <p className="legal-page__paragraph">
                ...
                <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" className="legal-page__link">
                  www.cnil.fr
                </a>
              </p>
            </div>
