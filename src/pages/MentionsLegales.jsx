      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <section className={styles.section}>
            ...
            <p className={styles.brand}>Sausset Réuni</p>
            <p className={styles.paragraph}>
            ...
            <p className={styles.paragraph}>
              ...
              <em className={styles.muted}>Il s'agit du local de campagne de la liste et non des locaux de la mairie.</em>
            </p>
            <p className={styles.paragraph}>
          ...
          <section className={styles.section}>
            <h2 className={styles.sectionTitle}>Propriété intellectuelle et droits à l'image</h2>
            <p className={styles.paragraph}>
